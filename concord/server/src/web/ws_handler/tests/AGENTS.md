...
This directory owns tests for concord/server/src/web/ws_handler. Keep scenario modules organized by behavior and share setup through the existing fixture owner.
